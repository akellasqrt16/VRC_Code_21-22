...
int main() {
  ...
  while (1) {
    ...
    rightTopDriveMotor.spin(vex::directionType::fwd, Yeetroller.Axis3.position(), vex::velocityUnits::pct );
    leftBottomDriveMotor.spin(vex::directionType::fwd, Yeetroller.Axis3.position(), vex::velocityUnits::pct );
    rightBottomDriveMotor.spin(vex::directionType::fwd, Yeetroller.Axis3.position(), vex::velocityUnits::pct );
